    ...
    <div class="py-12">
        <div class="max-w-7xl mx-auto sm:px-6 lg:px-8">
            ...
            <div class="bg-white overflow-hidden shadow-sm sm:rounded-lg">
                <form method="POST" action="{{ route($user ? 'users.update' : 'users.register') }}" class="overflow-hidden overflow-x-auto p-6 bg-white border-b border-gray-200">
                    @csrf
                    @if (!$user)
                        <x-slot name="header">
                    ...
                    <div class="grid grid-cols-2 gap-4">                     
                        ...
                        <div>
                            ...
                            <x-text-input id="puesto" class="block mt-1 w-full" type="text" name="puesto" :value="old('puesto', $user->puesto ?? '')" required autofocus/>
