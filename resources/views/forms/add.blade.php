        ...
        <div class="max-w-7xl mx-auto p-6 drop-shadow-xl bg-white rounded-lg">
            ...
            <form id="form-create" action="{{ route('forms.register') }}" method="POST">
                ...
                <div class="mb-4">
                    ...
                    <textarea id="description" name="description" class="w-full border rounded p-2" rows="3" placeholder="Descripción opcional"></textarea>
                </div>                
    ...
    <template id="field-template">
        <div class="field mb-4 border-t border-t-black pt-4">
            ...
            <div class="options-container hidden mb-2">
                ...
                <x-text-input class="block mt-1 w-full" type="text" name="fields[__INDEX__][options]" placeholder="Opción1,Opción2,Opción3"/>
            </div>
        ...
        document.addEventListener('DOMContentLoaded', function () {
            ...
            addFieldButton.addEventListener('click', function () {
                ...
                fieldElement.querySelector('select').addEventListener('change', function () {
                    const optionsContainer = this.closest('.field').querySelector('.options-container');
