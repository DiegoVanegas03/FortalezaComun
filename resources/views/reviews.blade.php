    ...
    <main class=" pt-[95px]  h-screen px-6">
        ...
        <div class="container mx-auto grid grid-cols-2 gap-4">
            ...
            <div>
                ...
                <form method="post" action="reviewsAdd" class="w-full grid grid-cols-1 gap-3">
                    @csrf
                    @method('post')
                    <textarea name="review" id="review" placeholder="Reseña..." class="rounded-lg border resize-none"></textarea>
                    <button type="submit" class="w-full text-center bg-black text-white rounded-lg p-3 text-lg">
                        Guardar
                    </button>
                </form>
            </div>
